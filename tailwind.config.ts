  ...
  theme: {
    extend: {
      fontFamily: {
        ...
        heading: ['var(--font-plus-jakarta)', 'var(--font-inter)', 'ui-sans-serif', 'system-ui', 'sans-serif'],
        mono: ['ui-monospace', 'SFMono-Regular', 'Menlo', 'Monaco', 'Consolas', 'monospace'],
      },
      colors: {
        // Extended blues with more vibrant options
        blue: {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
      ...
      backgroundImage: {
        ...
        "dark-glass-gradient": "linear-gradient(to right bottom, rgba(17, 24, 39, 0.7), rgba(17, 24, 39, 0.6))",
      },
      animation: {
