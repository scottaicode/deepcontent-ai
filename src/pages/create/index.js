...
export default function CreateIndexPage() {
  ...
  useEffect(() => {
    console.log('[DEBUG] Create/index page mounted');
    
    // Log current pathname
    if (typeof window !== 'undefined') {
      console.log('[DEBUG] Current path from create/index:', window.location.pathname);
    }
    
    return () => {
      console.log('[DEBUG] Create/index page unmounted');
    };
  }, []);

  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('[DEBUG] Form submitted (create/index):', { topic, audience, platform });
    ...
    // Simulate processing
    setTimeout(() => {
      console.log('[DEBUG] Processing complete (create/index)');
  ...
  return (
    <>
      <Head>
        <title>Create Content (Subdirectory) - DeepContent AI</title>
      ...
      <div className="container mx-auto py-24 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8 text-center">
            <h1 className="text-3xl font-bold mb-2">Create Content (Subdirectory Page)</h1>
