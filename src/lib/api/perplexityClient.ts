...
export class PerplexityClient {
  ...
  async generateResearch(prompt: string, options: any = {}): Promise<string> {
    ...
    console.log(`[DIAGNOSTIC] Perplexity generating research with language: ${language}`);
    ...
    const languageSpecificInstructions = language === 'es' 
      ? `Proporcione una investigación detallada y bien estructurada en español. Utilice títulos y secciones claras en español. Incluya citas y fuentes actuales. Toda la respuesta debe estar en español.`
