    ...
    <AppShell>
      <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-900">AI Text-to-Image Generator</h1>
          <p className="mt-4 text-lg text-gray-500">
            Create brand new images from your text descriptions. Unlike the Image Editor which
            modifies existing images, this tool creates entirely new images from scratch.
          </p>
        </div>
          ...
          <div className="bg-white shadow-sm rounded-lg p-6">
            <div className="space-y-6">
              <div className="bg-blue-50 rounded-lg p-4">
                <h3 className="text-lg font-medium text-blue-900">AI Text-to-Image Generator</h3>
                <p className="mt-2 text-sm text-blue-700">
                  Enter a text description and our AI will generate an image based on your prompt.
                </p>
                <div className="mt-3">
                  <p className="text-sm text-blue-700">Note: Image generation requires access to advanced AI capabilities.</p>
              ...
              {apiLimited && (
                <div className="bg-amber-50 border border-amber-200 p-4 rounded-lg">
                  ...
                  <p className="text-amber-700 text-sm">
                    The image generation request was not successful. This is likely because:
                  </p>
                  <ul className="list-disc list-inside text-amber-700 text-sm mt-2 ml-2">
                    <li>Gemini 2.0 Flash image generation is an experimental feature (released March 12, 2025)</li>
              ...
              {error && (
                <div className="rounded-md bg-red-50 p-4">
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <h3 className="text-sm font-medium text-red-800">Error generating image: {error}</h3>
                    </div>
                  </div>
                </div>
              )}
              ...
              {generatedImage && (
                <div className="mt-6">
                  <h4 className="text-lg font-medium text-gray-900 mb-4">Generated Image</h4>
